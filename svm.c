...
/* {{{ int SVM::setOptions([array params]);
...
static int count_occurences_of(const char needle, const char *haystack)
{
	int occurances = 0;
...
static zend_bool php_svm_read_array(php_svm_object *intern, zval *array)
{
	zval **ppzval;
